 ...
 */
class ReceivementsControllerImportaParenti extends JControllerForm
{
	public function getModel($name = 'ImportaParenti', $prefix = 'ReceivementsModel')
	{
		...
		JSession::checkToken() or jexit(JText::_('JINVALID_TOKEN'));
                ...
                $src = $file['tmp_name'];
                $dest = JPATH_COMPONENT . DIRECTORY_SEPARATOR . "assets" . DIRECTORY_SEPARATOR . "csv" . DIRECTORY_SEPARATOR . $filename;
                ...
                if ( strtolower(JFile::getExt($filename)) == 'csv') {
                        ...
                        $this->setRedirect('index.php?option=com_receivements&view=importaparenti&layout=error&msg=COM_RECEIVEMENTS_WRONG_EXTENSION&tmpl=component');
                }
        }
}