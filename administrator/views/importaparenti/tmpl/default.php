...
<form action="<?php echo JRoute::_('index.php?option=com_receivements&task=importaparenti.go&tmpl=component'); ?>" method="post" name="adminForm" id="import-form" enctype="multipart/form-data">
        <fieldset style="font-size:1.4em">
            <legend><?php echo JText::_('COM_RECEIVEMENTS_PARENTS_IMPORT'); ?></legend>
            <ul class="adminformlist">

				<li><?php echo $this->form->getLabel('upload_parents'); ?>
				<?php echo $this->form->getInput('upload_parents'); ?></li>
    ...
    <input type="hidden" name="task" value="importaparenti.go" />
